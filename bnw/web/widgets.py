...
class Widgets(object):
    ...
    def ranq(self):
        phrases = (
            ...
            u'Отдал бы и ползарплаты!',
            u'Мохнатые уроды и моральные пёзды.',
            u'Ваша великорусская мечта — сидя по горло в дерьме, затащить туда всех остальных. Это и есть Русизм.',
            # Шрифты говно.
            (u'\u0428\u0300\u0310\u0314\u0301\u033e\u0303\u0352\u0308\u0314'
             u'\u030e\u0334\u035c\u0334\u0341\u0341\u031c\u0325\u034d\u0355'
             u'\u033c\u0319\u0331\u0359\u034e\u034d\u0318\u0440\u0367\u0364'
