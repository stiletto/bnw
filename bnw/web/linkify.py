...
linkhostings = [
    ...
    (ur'https?://(?:www\.)?youtube.com/watch\?(?:.+&)?v\=([A-Z0-9a-z_-]+)(?:&.+)?', lambda m,s: 'http%s://img.youtube.com/vi/%s/default.jpg' % (m(1),)),
    ...
    (ur'(?i)https?://(.+.(?:png|gif|jpg|jpeg))', lambda m,s: 'http%s://uglyhx.appspot.com/thumb?img=%s' % (s,url_escape(m(0)),)),
]
