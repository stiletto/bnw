...
if __name__ == "__main__":
    ...
    test = (
        ...
        ("post --clubs=ddash  --    keep extra spaces   ",
            ("post", "text", {"clubs": "ddash"}, "   keep extra spaces   ")),
        ("post --clubs=ddash   --\n\n\nkeep newlines",
            ("post", "text", {"clubs": "ddash"}, "\n\nkeep newlines")),
        ("comment -m 123456 ТЫ ГОВНО",
            ("comment", "text", {"message": "123456"}, "ТЫ ГОВНО")),
        ("comment -m 123456 -- -a НЕТ ТЫ",
            ("comment", "text", {"message": "123456"}, "-a НЕТ ТЫ")),
        ("c --message=123456/123",
            ("comment", "text", {"message": "123456/123"}, "")),
        ("subscribe -t mytag",
            ("subscribe", None, {"tag": "mytag"}, "")),
        ("subscribe -u krkm --",
            ("subscribe", None, {"user": "krkm"}, "")),
        ("subscribe -c bnw -- ",
            ("subscribe", None, {"club": "bnw"}, "")),
        ("subscriptions",
            ("subscriptions", None, {}, "")),
